...
fig.write_html('C:\\Users\\rysza\\Desktop\\python data analysis\\Project\\interactiveplots\\sex_age_group.html',include_plotlyjs=False)
fig_json_4 = fig.to_html(full_html=False,include_plotlyjs='cdn')
fig.show()