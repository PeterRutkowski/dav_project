...
df1=df1[['Altersklasse','Total: Anzahl Fälle']]
df1=df1.rename(columns={'Altersklasse':'agegroup','Total: Anzahl Fälle':'total'})
df1=df1[:9]
...
fig = go.Figure(data=[
    go.Bar(name='Cases', x=df1['agegroup'], y=df1['total']),
...
fig.update_layout(
    ...
    plot_bgcolor='white',
    title={
        'text': "Total deaths and cases in Switzerland by age groups",
        'y':0.85,
        'x':0.52,
        'xanchor': 'center',
        'yanchor': 'top',
...
fig.write_html('C:\\Users\\rysza\\Desktop\\python data analysis\\Project\\interactive_plots\\age_group_total.html', include_plotlyjs='cdn')